...
def get_JointTraj():
	...
	i = 2
	t_traj = 2 
	with open('../../graspberry_planning/src/promp/src/GRASPberry_Config1_Pushing.npz', 'r') as f1:
		Q1 = np.load(f1)
		Q1 = np.squeeze(Q1)
        ...
        wptsJ0 = [JJ0[-40], JJ0[-20], JJ0[-1], J0[-2], J0[-1], JJ0[-1], 0]
        wptsJ1 = [JJ0[-40]-3.14, JJ1[-20]- 3.14, JJ1[-1]- 3.14, J1[-2]- 3.14, J1[-1]- 3.14, JJ1[-1]- 3.14, 0]
        wptsJ2 = [JJ0[-40], JJ2[-20], JJ2[-1], J2[-2], J2[-1], JJ2[-1], 0]
